...
The script creates 4 subdirectories:
- ```./inference``` 
- ```./inference/bif```
- ```./inference/sif```
- ```./inference/cpd```
...
The script infers the bayesian networks, saving its' output in 3 formats, saving the tests inside subdirectories created before. 
