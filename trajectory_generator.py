...
def main():
    ...
    parser.add_argument("-tg-ds", "--tg-ds-prefix", type=str, default="datasets/trajs_bn_", help="Trajectory dataset filename prefix for a specific boolean network (.json format, to be generated)")
